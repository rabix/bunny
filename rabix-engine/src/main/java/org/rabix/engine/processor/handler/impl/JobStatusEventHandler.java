  ...
  public void handle(JobStatusEvent event) throws EventHandlerException {
    ...
    case READY:
      ...
      if (!jobRecord.isContainer() && !jobRecord.isScatterWrapper()) {
        ...
        try {
          containerJob = JobHelper.createJob(jobRecord, JobStatus.READY, jobRecordService, variableRecordService, linkRecordService, contextRecordService, dagNodeDB, true);
