...
public class CWLDocumentResolverReplacement {

  private final JsonNode parentNode;
  private final JsonNode referenceNode;
  private final String normalizedReferencePath;
  
  public CWLDocumentResolverReplacement(JsonNode parentNode, JsonNode referenceNode, String normalizedReferencePath) {
    super();
  ...
  public boolean equals(Object obj) {
    ...
    if (getClass() != obj.getClass())
      return false;
    CWLDocumentResolverReplacement other = (CWLDocumentResolverReplacement) obj;
  ...
  public String toString() {
    return "CWLDocumentResolverReplacement [normalizedReferencePath=" + normalizedReferencePath + ", parentNode=" + parentNode
